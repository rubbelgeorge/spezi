...
<img width="1470" alt="Screenshot 1" src="screenshots/img1c.png" />

<img width="1470" alt="Screenshot 2" src="screenshots/img2c.png" />
...
## Notes
- **Bit-Depth**  
  This tool only switches the sample rate, not the Bit-Depth. So make sure, that your audio device is set to 24 Bit or more.  
- **Visualizers**  
