...
const app = new PIXI.Application({
    ...
    window.visualizerName = 'Phenomenon';


// Inject frosted-glass overlay, ensuring full coverage and preventing stacking filter effects
...
app.ticker.add((delta) => {
    filter.uniforms.time += 0.005 * delta;
});
};
